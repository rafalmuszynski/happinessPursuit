...
def updatePaddle1(action, paddle1YPos):
    """ update the paddle position of the player on the left """
...
def updatePaddle2(action2, paddle2YPos):
    """ update the paddle position of the player on the right """
...
class PongGame:
    ...
    def getNextFrame(self, action, action2):
        pygame.event.pump()
        screen.fill(BLACK)
        ...
        self.paddle2YPos = updatePaddle2(action2, self.paddle2YPos)
        drawPaddle2(self.paddle2YPos)
